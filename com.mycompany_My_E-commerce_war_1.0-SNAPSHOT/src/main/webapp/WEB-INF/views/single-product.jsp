                                        ...
                                        <div class="product-slider product-shop">
                                            ...
                                            <ul class="slides">
                                                ...
                                                <!--<li data-thumb="img/temp-images/vv/Burger-140x140.jpg">-->
                                                    ...
                                                    <img src="img/fimg1000/${product.image}" class="attachment-shop_single" height="500" width="500" title="aaaaaaaaaaaaa" alt="image">
                                                ...
                                                <!--<li data-thumb="img/temp-images/vv/Burger_back-140x140_1.jpg">-->
                                                    ...
                                                    <!--<a href="img/temp-images/vv/Burger_back.jpg" data-imagelightbox="gallery" class="hoodie_7_back">-->
                                                        <img src="img/bimg1000/${product.image}" class="attachment-shop_single" height="500" width="500" alt="image">
