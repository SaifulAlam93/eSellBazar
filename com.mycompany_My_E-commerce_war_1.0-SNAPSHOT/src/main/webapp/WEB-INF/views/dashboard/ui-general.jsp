<%-- 
    Document   : ui-general
    Created on : Aug 5, 2020, 9:08:10 AM
    Author     : Saiful
--%>
							...
							<div class="card">
								...
								<div class="card-body">
									<div class="text-center">
										<img class="rounded mr-2 mb-2" src="dcss/img/avatars/avatar.jpg" alt="Placeholder" width="140" height="140">
										<img class="rounded-circle rounded mr-2 mb-2" src="dcss/img/avatars/avatar.jpg" alt="Placeholder" width="140" height="140">
										<img class="img-thumbnail rounded mr-2 mb-2" src="dcss/img/avatars/avatar.jpg" alt="Placeholder" width="140" height="140">
									</div>
								</div>
							</div>
