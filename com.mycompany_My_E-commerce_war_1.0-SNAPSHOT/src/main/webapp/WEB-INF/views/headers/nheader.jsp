            ...
            <div class="top-bar">
                <div class="container">
                    ...
                    <div class="tb-shopping-cart pull-right">
                        <!-- Link with badge -->
                        <a href="#" class="btn btn-white btn-xs b-dropdown"><i class="fa fa-shopping-cart"></i> <i class="fa fa-angle-down color"></i> <span class="badge badge-color">${fn:length(cartlist)}</span></a>
                                ...
                                <c:forEach var="cart" items="${cartlist}">
                                    <li>
                                        ...
                                        <div class="cart-img">
                                            ...
                                            <!--<a href="#"><img src="img/fimg140/$ {cart.image}.png" alt="" class="img-responsive" /></a>-->
                                            <a href="#"><img src="img/fimg1000/${cart.image}" alt="" width="40px"  height="60px" /></a>
                                        </div>
                            ...
                            <form method="post" action="search">
                                ...
                                <div class="input-group">
                                    ...
                                    <span class="input-group-btn">
                                        <button class="btn btn-color"><input type="submit" value="Search bar"/></button>
                                    </span>
                                </div>
                            </form>
                        </div>
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-md-4 col-sm-4">
                            ...
                            <div class="logo">
                                <!--fa-bookmark-o-->
                                <h1><a href="index"><i class="fa "></i><img src="img/favicon75.png" height="45" width="45"/>SellBazar</a></h1>
                            </div>
                        </div>
                        <div class="col-md-6 col-md-offset-2 col-sm-5 col-sm-offset-3 hidden-xs">
                            <!-- Search Form -->
                            <div class="header-search">
                                <form method="post" action="search?pageid=1">
                                    <!-- Input Group -->
                                    <div class="input-group">
                                        <input type="text" class="form-control" name="name" value="${searchtext}" placeholder="Type Something">
                                        <span class="input-group-btn">
                            ...
                            <ul>
                                ...
                                <li><a href="#">Category</a>
                                    <ul>
                                        <li><a href="#">Laptop</a>
                                            <ul>
                                                <li><a href="desh/indexd">Vaio</a></li>
